...
class ProductsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'price' => ['type' => 'decimal', 'length' => 13, 'precision' => 2, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
        ...
        '_indexes' => [
            ...
            'unit_key' => ['type' => 'index', 'columns' => ['unit_id'], 'length' => []],
        ],
        '_constraints' => [
            ...
            'unit_key' => ['type' => 'foreign', 'columns' => ['unit_id'], 'references' => ['units', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'created' => '2017-09-30 06:50:46',
            'modified' => '2017-09-30 06:50:46'
        ],
    ];
}
